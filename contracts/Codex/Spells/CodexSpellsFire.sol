...
contract CodexSpellsFire {
    ...
    {
        if (_id == 1) {
            return BurningBolt(_tier);
        } else if (_id == 2) {
            return Fireball(_tier);
        } else if (_id == 3) {
            return FireBlast(_tier);
        } else if (_id == 4) {
            return Inferno(_tier);
        } else if (_id == 5) {
            return MeteorSwarm(_tier);
        } else if (_id == 6) {
            return PuryfingFire(_tier);
        } else if (_id == 7) {
            return InfernalArmy(_tier);
        } else if (_id == 8) {
            return HellishRebuke(_tier);
        }

        revert("invalid");
    }

    function BurningBolt(uint256 tier)
        public
        pure
    ...
    function Fireball(uint256 tier) public pure returns (Spell memory _spell) {
        _spell.id = 2;
        _spell.cooldown = 4;
        _spell.spellType = SpellType.ATTACK;
    ...
    function FireBlast(uint256 tier) public pure returns (Spell memory _spell) {
        _spell.id = 3;
        _spell.cooldown = 4;
        _spell.spellType = SpellType.ATTACK;
    ...
    function Inferno(uint256 tier) public pure returns (Spell memory _spell) {
        _spell.id = 4;
        _spell.cooldown = 5;
    ...
    function MeteorSwarm(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function PuryfingFire(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function InfernalArmy(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function HellishRebuke(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {

...
contract CodexSpellsLightning {
    ...
    function LightningBolt(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 1;
        _spell.cooldown = 3;
        _spell.spellType = SpellType.ATTACK;

        _spell.attackProps.element = Element.LIGHTNING;
    ...
    function LightningCharge(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 2;
        _spell.cooldown = 4;
        _spell.spellType = SpellType.ATTACK;
    ...
    function LightningBall(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 3;
        _spell.cooldown = 4;
        _spell.spellType = SpellType.ATTACK;
    ...
    function LightningBody(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 4;
        _spell.cooldown = 5;
    ...
    function Thunderclaw(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 5;
        _spell.cooldown = 5;
        _spell.spellType = SpellType.ATTACK;
    ...
    function AvatarOfStorm(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 6;
        _spell.cooldown = 6;
        _spell.spellType = SpellType.ATTACK;
        ...
        _spell.attackProps.multiplierBonusPerTier = 14;
        _spell.attackProps.infusion = 5;
        _spell.attackProps.infusionBonusPerTier = 1;
    ...
    function SummoningRitual(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 7;
        _spell.cooldown = 6;
        _spell.spellType = SpellType.ATTACK;
    ...
    function StormOfVengeance(uint tier) public pure returns (Spell memory _spell) {
        _spell.id = 8;
        _spell.cooldown = 6;
        _spell.spellType = SpellType.ATTACK;

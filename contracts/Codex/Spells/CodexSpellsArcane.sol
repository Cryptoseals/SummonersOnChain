...
contract CodexSpellsArcane {
    ...
    {
        if (_id == 1) {
            return ArcaneBolts(_tier);
        } else if (_id == 2) {
            return MinorIllusions(_tier);
        } else if (_id == 3) {
            return ChromaticOrb(_tier);
        } else if (_id == 4) {
            return Charm(_tier);
        } else if (_id == 5) {
            return MirrorImage(_tier);
        } else if (_id == 6) {
            return ShatteredDreams(_tier);
        } else if (_id == 7) {
            return MassHypnosis(_tier);
        } else if (_id == 8) {
            return MindSliver(_tier);
        }

        revert("invalid");
    }

    function ArcaneBolts(uint256 tier)
        public
        pure
    ...
    function MinorIllusions(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function ChromaticOrb(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function Charm(uint256 tier) public pure returns (Spell memory _spell) {
        _spell.id = 4;
        _spell.cooldown = 5;
    ...
    function MirrorImage(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function ShatteredDreams(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function MassHypnosis(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {
    ...
    function MindSliver(uint256 tier)
        public
        pure
        returns (Spell memory _spell)
    {

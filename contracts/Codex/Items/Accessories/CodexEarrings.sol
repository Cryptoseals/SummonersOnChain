...
contract CodexEarrings is InitNavigator, OwnableUpgradeable {
    ...
    function earringStats(uint index) internal view returns (GameObjects_Stats.Stats memory) {
    ...
    function earringEleD(uint index) internal view returns (GameObjects_Stats.ElementalAtk memory) {
    ...
    function earringEle(uint index) internal view returns (GameObjects_Stats.ElementalDef memory) {
    ...
    function earringGenStats(uint index) internal view returns (GameObjects_Stats.GeneratedStats memory) {
    ...
    function earringEleStats(uint index) internal view returns (GameObjects_Stats.ElementalStats memory _genStats) {

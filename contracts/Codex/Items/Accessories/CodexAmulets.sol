...
contract CodexAmulets is InitNavigator, OwnableUpgradeable {
    ...
    function applyPrefixAndSuffix(Prefix memory _pre, Suffix memory _suf, EquipableItem memory _amulet) public view returns (EquipableItem memory) {
    ...
    function applyPrefix(Prefix memory _pre, EquipableItem memory _amulet) public view returns (EquipableItem memory) {
        if (_pre.isPercentage) {
            _amulet.generatedStatBonus = EquipableUtils.sumGeneratedStatsAsPercentage(_amulet.generatedStatBonus, _pre.generatedStatBonus);
            _amulet.elementalStats = EquipableUtils.sumGeneratedElementalStatsAsPercentage(_amulet.elementalStats, _pre.elementalStats);
        } else {
    ...
    function applySuffix(Suffix memory _suf, EquipableItem memory _amulet) public view returns (EquipableItem memory) {
        if (_suf.isPercentage) {
            _amulet.generatedStatBonus = EquipableUtils.sumGeneratedStatsAsPercentage(_amulet.generatedStatBonus, _suf.generatedStatBonus);
            _amulet.elementalStats = EquipableUtils.sumGeneratedElementalStatsAsPercentage(_amulet.elementalStats, _suf.elementalStats);
        } else {
    ...
    function applyTier(EquipableItem memory _amulet, uint tier, uint percentage) public view returns (EquipableItem memory){
    ...
    function allAmulet() external view returns (EquipableItem[] memory){
    ...
    function amuletCore(uint itemId, uint itemTier) public view returns (EquipableItem memory) {
        EquipableItem memory _amulet;
    ...
    function FrailAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
        _amulet.metadata.id = 1;
        _amulet.metadata.baseType = ItemType.AMULET;
        _amulet.metadata.upgradable = true;

        _amulet.requirement.level = 1;
        //  _amulet.requirement.statRequirement = Stats({STR : 0, DEX : 0, AGI : 0, INT : 0, VIT : 0, LUCK : 0});
    ...
    function AntiqueAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function PurgeAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function BarbedAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function ReflectiveAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function StormForgedAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function VerdantAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function ShadowfallAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function MalignantAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function SealedAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function TemplarAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function ChannelerAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function ChosensAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function AstraAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function SoulbinderAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function MoonlightAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function SunlightAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function CycleAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function InfernalAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function DivineAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function EternalAmulet(uint tier) public view returns (EquipableItem memory _amulet) {
    ...
    function amuletStats(uint _index) internal view returns (Stats memory) {
    ...
    function amuletEleD(uint _index) internal view returns (ElementalAtk memory) {
    ...
    function amuletEle(uint _index) internal view returns (ElementalDef memory) {
    ...
    function amuletGenStats(uint _index) internal view returns (GeneratedStats memory) {
    ...
    function amuletEleStats(uint _index) internal view returns (ElementalStats memory _genStats) {

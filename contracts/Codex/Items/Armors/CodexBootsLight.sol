...
//        LUCK : 0});
    ...
    function MoonShoes(uint tier) public view returns (GameObjects.Boots memory _grieves) {
...
//        LUCK : 0});
    ...
    function SunShoes(uint tier) public view returns (GameObjects.Boots memory _grieves) {

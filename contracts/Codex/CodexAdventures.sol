...
contract CodexAdventures {
    ...
    function DummyAdventure(uint difficulty) public pure returns (IAdventure.AdventureLevel memory _adventure) {
        ...
        _adventure.Monster.damageType = IMonster.Element.FIRE;

        _adventure.Monster.EnemyElementalStats.ElementalAtk = IMonster.ElementalAtk({FIRE_ATK : 1, COLD_ATK : 1, EARTH_ATK : 1, LIGHTNING_ATK : 1, DARK_ATK : 1, HOLY_ATK : 1, VOID_ATK : 1});
        _adventure.Monster.EnemyElementalStats.ElementalDef = IMonster.ElementalDef({FIRE_DEF : 1, COLD_DEF : 1, EARTH_DEF : 1, LIGHTNING_DEF : 1, DARK_DEF : 1, HOLY_DEF : 1, VOID_DEF : 1});
        _adventure.Monster.EnemyGeneratedStats = IMonster.GeneratedStats({HP : 0, P_ATK : 0, M_ATK : 0, P_DEF : 0, M_DEF : 0, ACCURACY : 0, DODGE : 0, CRIT : 0, CRIT_MULTIPLIER : 0, INFUSION : 0});
        _adventure.Monster.EnemyStats = IMonster.Stats({STR : 0, AGI : 0, INT : 0, DEX : 0, VIT : 0, LUCK : 0});

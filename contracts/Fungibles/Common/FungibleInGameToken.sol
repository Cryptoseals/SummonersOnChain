...
contract FungibleInGameToken is ERC20, IFungibleInGameToken, InitNavigator {

    constructor(string memory _name, string memory _symbol, address _navigator) InitNavigator(_navigator)
    ERC20(_name, _symbol) {}

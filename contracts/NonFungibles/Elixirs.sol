...
contract Elixirs is Initializable, OwnableUpgradeable, InitNavigator, ERC721EnumerableUpgradeable {

    mapping(uint => uint) public tokenToElixirId;
    ...
    function mintItem(address player, uint elixirId, uint elixirTier) external onlyGameContracts {
        uint nextToken = totalSupply() + 1;
        tokenToElixirId[nextToken] = elixirId;
        tokenToEnchantmentLevel[nextToken] = elixirTier;

...
export const DeployedFileLocations = {
    ...
    codex_armor_main: "./scripts/deployed-contracts/codex_armor_main.json",
    ...
    crafting_recipes: "./scripts/deployed-contracts/crafting_recipes.json",
    attributes: "./scripts/deployed-contracts/attributes.json",
